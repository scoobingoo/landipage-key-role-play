...
const NewsCard: React.FC<NewsCardProps> = ({
  ...
  >
    ...
    <div className="p-6 flex flex-col flex-grow relative">
      {/* Floating Icon */}
      <div className="absolute -top-6 right-6 w-12 h-12 bg-dark border-2 border-primary rounded-lg flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-colors duration-300 shadow-lg z-10">
        <Icon size={24} />
      </div>
